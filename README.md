...
<link rel=File-List href="MichiGen.fld/filelist.xml">
<![if !supportTabStrip]>
<link id="shLink" href="MichiGen.fld/sheet001.htm">
 ...
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    ...
    <x:WorksheetSource HRef="MichiGen.fld/sheet001.htm"/>
   </x:ExcelWorksheet>
  </x:ExcelWorksheets>
  <x:Stylesheet HRef="MichiGen.fld/stylesheet.css"/>
...
<frameset rows="*,39" border=0 width=0 frameborder=no framespacing=0>
 <frame src="MichiGen.fld/sheet001.htm" name="frSheet">
 <frame src="MichiGen.fld/tabstrip.htm" name="frTabs" marginwidth=0 marginheight=0>
 <noframes>
  <body>
